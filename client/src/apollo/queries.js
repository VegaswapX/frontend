...
export const FACTORY_PAIRS = gql`
{
  factory(id: "0xca143ce32fe78f1f7019d7d551a6402fc5350c73") {
    id
    totalPairs
    totalTokens
  } 
...
// export const GET_CANDLE_DATA = gql`
// 	query candles ($token0: Bytes!, $token1: Bytes!, $from: Int!, $to: Int!, $period: Int!, $count: Int) {
// 		candles(
// 			first: $count,
// 			where: {
// 				period: $period,
...
// export const PAIR_SEARCH_ONE = gql`
// 	query pairs($token1: [Bytes]!, $token2: [Bytes]!) {
// 		as0: pairs(where: { token0_in: $token1, token1_in: $token2 }) {
// 			id
// 		}
// 		as1: pairs(where: { token0_in: $token2, token1_in: $token1 }) {
// 			id
// 		}
// 	}
// `
...
// export const FILTERED_TRANSACTIONS_SWAPS = gql`
//   query($allPairs: [Bytes]!) {        
//     swaps(first: 30, where: { pair_in: $allPairs }, orderBy: timestamp, orderDirection: desc) {
//       transaction {
//         id
